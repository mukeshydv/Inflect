...
enum Constants {
    ...
    static let plSbCIsIdes = joinStem(cutPoint: 2, words: Constants.pl_sb_C_is_ides_complete.appending(contentsOf: Constants.pl_sb_C_is_ides_endings.map { ".*\($0)" }))
    
    static let plSbCIsIdesListTemp = Constants.pl_sb_C_is_ides_complete.appending(contentsOf: Constants.pl_sb_C_is_ides_endings)
